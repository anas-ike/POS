                    ...
                    <div class="row">
                        <div class="col-lg-8 mb-3 pr-3">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" name="barcode" class="form-control" id="barcode" placeholder="barcode" autofocus autocomplete="off" required>
                            </div>
                            <div class="form-group">
                                    <label for="name">Nama *</label>
                                    <input type="text" name="name" class="form-control" id="name" placeholder="nama barang" autofocus autocomplete="off" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-4 text-center px-3">
                            <img src="<?= $main_url ?>asset/image/default-brg.png" class="profile-user-img mb-3 mt-4" alt="">
