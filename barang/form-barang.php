                    ...
                    <div class="row">
                        <div class="col-lg-8 mb-3 pr-3">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" name="barcode" class="form-control" id="barcode" value="<?= $msg != '' ? $barang['barcode'] : null ?>" placeholder="barcode" autofocus autocomplete="off" required>
                            </div>
                            <div class="form-group">
                                    <label for="name">Nama *</label>
                                    <input type="text" name="name" class="form-control" id="name" placeholder="nama barang" value="<?= $msg != '' ? $barang['nama_barang'] : null ?>" autofocus autocomplete="off" required>
                            </div>
                            <div class="form-group">
